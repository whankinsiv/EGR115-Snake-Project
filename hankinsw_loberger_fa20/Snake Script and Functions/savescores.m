...
%savescores - Saves the passed score to a text file and returns highscore.
%Recieves an input argument for score and adds the score to the scores.txt
%file, then returns highscore. If no score is passed to the function, 
%highscore is returned and no changes are made to scores.txt
%
%Created by: William Hankins
%
%Syntax: highscore = savescores(score)
